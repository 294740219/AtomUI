...
namespace AtomUI.Desktop.Controls.Labs.Performance;
...
internal static class Program
{
        ...
        MatrixSoakResult soakResult)
    {
        ...
        builder.AppendLine("- Runner: `tools/performances/AtomUI.Desktop.Controls.Labs.Performance --count <N> --frames <N> --soak-frames <N>`");
